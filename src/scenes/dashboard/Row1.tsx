    ...
    return (
        <>
            <DashboardBox gridArea='a'>
                <BoxHeader title='Revenue and Expense' subtitle='Top line represents revenue and bottom line represents expenses.' sideText='+4%' />
            ...
            <DashboardBox gridArea='b'>
                <BoxHeader title='Profit and Revenue' subtitle='Top line represents revenue and bottom line represents expenses.' sideText='+4%' />
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart
                        data={revenueProfit}
                        margin={{
